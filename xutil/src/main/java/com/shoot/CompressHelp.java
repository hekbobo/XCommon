...
import com.shoot.io.XFileUtils;

import java.io.File;

public class CompressHelp {

        private static volatile CompressHelp INSTANCE;
        ...
        public static CompressHelp getDefault(Context context) {
            if (INSTANCE == null) {
                synchronized (CompressHelp.class) {
                    if (INSTANCE == null) {
                        INSTANCE = new CompressHelp(context);
                    }
                }
            }
            return INSTANCE;
        ...
        private CompressHelp(Context context) {
            this.context = context;
            destinationDirectoryPath = context.getCacheDir().getPath() + File.pathSeparator + "compress";
        }
        ...
        public File compressToFile(File file) {
            return XBitmapUtil.compressImage(context, Uri.fromFile(file), maxWidth, maxHeight,
        ...
        public Bitmap compressToBitmap(File file) {
            return XBitmapUtil.getScaledBitmap(context, Uri.fromFile(file), maxWidth, maxHeight, bitmapConfig);
        }
        ...
        public static class Builder {
            private CompressHelp mCompressHelper;

            public Builder(Context context) {
                mCompressHelper = new CompressHelp(context);
            }
